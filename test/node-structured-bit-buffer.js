...
describe('Structured Bit Buffer Module Test', function() {
    ...
    describe('Bit Buffer Test', function() {
        ...
        it('setBit method Test', function() {
            bb = new BitBuffer(buffer);
            bb.setBit(0);
            expect(bb.toString()).to.equal('000000000000000000000000000000000000000000000001');
            bb.setBit(2);
            expect(bb.toString()).to.equal('000000000000000000000000000000000000000000000101');
            bb.setBit(4);
            expect(bb.toString()).to.equal('000000000000000000000000000000000000000000010101');
            bb.setBit(6);
            expect(bb.toString()).to.equal('000000000000000000000000000000000000000001010101');
        });
